...
export const translations = {
  ...
  vi: {
    ...
    mbaRankings: "Bảng xếp hạng",
    mbaApplicationFAQ: "Câu hỏi thường gặp",
    mbaApplicationStrategy: "Chiến lược ứng tuyển",
    mbaResume: "Hồ sơ",
    mbaRecommendationLetter: "Thư giới thiệu",
    mbaEssayWriting: "Viết bài luận",
    mbaInterviews: "Phỏng vấn",
    mbaApplicationSummary: "Tóm tắt ứng tuyển",
    ...
    masterApplicationSummary: "Tóm tắt ứng tuyển",
    masterRecommendationLetter: "Thư giới thiệu",
    ...
    phdRanking: "Xếp hạng",
    phdStudyExperience: "Kinh nghiệm học tập",
    phdInterview: "Phỏng vấn",
    phdApplicationSummary: "Tóm tắt ứng tuyển",
    phdRecommendationLetter: "Thư giới thiệu",
    ...
    applicationResources: "Tài liệu ứng tuyển",
