...
export async function getPosts(
  ...
  try {
    ...
    console.error(
      "Error fetching posts from Supabase, falling back to mock data:",
      error
    );
...
export async function getPostById(id: string): Promise<any> {
  ...
  try {
    ...
    console.error(
      "Error fetching post from Supabase, falling back to mock data:",
      error
    );
  }
...
export async function getPostsByCategory(categoryId: string): Promise<any[]> {
  ...
  try {
    ...
    console.error(
      "Error fetching category posts from Supabase, falling back to mock data:",
      error
    );
    // Fall back to mock data
    return mockData.getMockPostsByCategory(categoryId);
