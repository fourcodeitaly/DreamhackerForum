// import type { Post } from "./db/posts/posts-modify";
// import { query, queryOne } from "./db/postgres";
// import { localAuth } from "./auth/local-auth";
// import { createClientSupabaseClient } from "./supabase/client";
// import { getPostCount } from "./db/posts/post-get";
...
// export async function searchPosts(inputQuery: string) {
//   try {
//     const sql = `
//       SELECT
//         p.*,
...
//     return await query(sql, [`%${inputQuery}%`]);
//   } catch (error) {
